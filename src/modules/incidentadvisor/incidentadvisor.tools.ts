...
export class IncidentAdvisorTools {
  ...
  async getIncidentGuidance(
    ...
    const guidance = this.getPlaybook(incidentType as any, severity as any);
  ...
  private getPlaybook(
    incidentType: 'phishing' | 'malware' | 'data_breach' | 'ransomware' | 'ddos' | 'account_compromise' | 'insider_threat' | 'supply_chain',
    severity: 'low' | 'medium' | 'high' | 'critical'
  ) {
    const playbookDb: Record<string, any> = {
      phishing: {
